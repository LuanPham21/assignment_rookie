...
namespace RookieShop.Data.Migrations
{
    ...
    [Migration("20220225035440_AspNetCoreDatabase")]
            ...
            modelBuilder.Entity("RookieShop.Data.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("Dob")
                        ...
                        .HasDefaultValue(new DateTime(2022, 2, 25, 10, 54, 39, 653, DateTimeKind.Local).AddTicks(7836));
            ...
            modelBuilder.Entity("RookieShop.Data.Entities.Order", b =>
                {
                    ...
                    b.Property<DateTime>("OrdersDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 25, 10, 54, 39, 652, DateTimeKind.Local).AddTicks(6533));
            ...
            modelBuilder.Entity("RookieShop.Data.Entities.Product", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 2, 25, 10, 54, 39, 653, DateTimeKind.Local).AddTicks(4061));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Quantity = 100,
                            Status = 1,
                            TimeCreate = new DateTime(2022, 2, 25, 10, 54, 39, 654, DateTimeKind.Local).AddTicks(90),
                            ViewCount = 1
                        },
                        new
                        {
                            ...
                            Quantity = 100,
                            Status = 1,
                            TimeCreate = new DateTime(2022, 2, 25, 10, 54, 39, 654, DateTimeKind.Local).AddTicks(94),
                            ViewCount = 1
                        });
                });
